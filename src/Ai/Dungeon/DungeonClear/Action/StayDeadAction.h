 ...
 *
 * Overrides mod-playerbots' "auto release" action so dead bots do NOT release
 * their spirit to the graveyard — they stay dead (a corpse on the ground) until
 * something resurrects them: a player/party rez, a self-resurrect (soulstone /
 * Reincarnation / etc.), or summon-and-revive.
 *
 ...
 * flag is off this behaves exactly like the stock AutoReleaseSpiritAction.
 *
